...
define ('SQLSERVER_MODELS', 'AppliedAccounting_BAS,DataAnalytics_BAS,HealthcareInformatics_BAS,HealthcareManagement_BAS,HealthcarePromotion_BAS,'
        ...
        . 'NursingAssistantCertifiedProgram, RAIS_DosimetryConcentration, NuclearMedicineProgram_AA, DiagnosticUltrasoundTechnologyProgram_AA'
        . 'NeurodiagnosticTechnologyProgram_AA');
