...
class IST_BAS {
	...
	public function build( $_entry ) {
		...
		$this->emplid     = ! empty( $_entry['77'] ) ? rgar( $_entry, '77' ) : null;
		...
		$this->personal_statement_upload = ! empty( $_entry['74'] ) ? rgar( $_entry, '74' ) : null;
		...
		} elseif ( ! empty( $_entry['75'] ) && strtolower( rgar( $_entry, '75' ) ) == 'yes' ) {
